namespace Framework.Test
{
    ...
    public static class AssertExtensions
    {
        ...
        public static void ContainsErrorCode<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, TErrorCode errorCode, params TErrorCode[] errorCodes)
        ...
        public static void ContainsErrorCode<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<TErrorCode> errorCodes)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="errorCode">The errorCode<see cref="TErrorCode"/>.</param>
        /// <param name="errorCodes">The errorCodes<see cref="TErrorCode[]"/>.</param>
        public static void NotContainsErrorCode<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, TErrorCode errorCode, params TErrorCode[] errorCodes)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="errorRecords">The errorRecords<see cref="ErrorRecords{TErrorCode}"/>.</param>
        /// <param name="errorCodes">The errorCodes<see cref="IEnumerable{TErrorCode}"/>.</param>
        public static void NotContainsErrorCode<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<TErrorCode> errorCodes)
            where TErrorCode : struct, Enum
        {
            var result = ErrorCode(errorRecords, errorCodes);
        ...
        public static void ContainsOrdinalPosition<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, int ordinalPosition, params int[] ordinalPositions)
            where TErrorCode : struct, Enum
        {
        ...
        public static void ContainsOrdinalPosition<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<int> ordinalPositions)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="ordinalPosition">The ordinalPosition<see cref="int"/>.</param>
        /// <param name="ordinalPositions">The ordinalPositions<see cref="int[]"/>.</param>
        public static void NotContainsOrdinalPosition<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, int ordinalPosition, params int[] ordinalPositions)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="errorRecords">The errorRecords<see cref="ErrorRecords{TErrorCode}"/>.</param>
        /// <param name="ordinalPositions">The ordinalPositions<see cref="IEnumerable{int}"/>.</param>
        public static void NotContainsOrdinalPosition<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<int> ordinalPositions)
            where TErrorCode : struct, Enum
        {
            var result = OrdinalPosition(errorRecords, ordinalPositions);
        ...
        private static bool ErrorCode<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<TErrorCode> errorCodes)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="ordinalPositions">The ordinalPositions<see cref="IEnumerable{int}"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
        private static bool OrdinalPosition<TKey, TErrorCode>(ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<int> ordinalPositions)
            where TErrorCode : struct, Enum
        {
