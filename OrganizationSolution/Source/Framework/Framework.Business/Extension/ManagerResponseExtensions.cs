namespace Framework.Business.Extension
{
    ...
    public static class ManagerResponseExtensions
    {
        ...
        public static ObjectResult ToStatusCode<Tkey, TErrorCode>(this ManagerResponseBase<Tkey, TErrorCode> managerResponse, int successCode = StatusCodes.Status200OK, int errorCode = StatusCodes.Status400BadRequest, int notFoundErrorCode = StatusCodes.Status404NotFound)
        ...
        /// <param name="notFoundErrorCode">The notFoundErrorCode<see cref="int"/>.</param>
        /// <returns>The <see cref="ObjectResult"/>.</returns>
        public static ObjectResult ToStatusCode<TKey, TErrorCode, TResult>(this ManagerResponseTyped<TKey, TErrorCode, TResult> managerResponse, int successCode = StatusCodes.Status200OK, int errorCode = StatusCodes.Status400BadRequest, int notFoundErrorCode = StatusCodes.Status404NotFound)
            where TErrorCode : struct, Enum
        {
            if (managerResponse.HasError)
            {
