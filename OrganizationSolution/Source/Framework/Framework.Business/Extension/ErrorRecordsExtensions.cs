namespace Framework.Business.Extension
{
    ...
    public static class ErrorRecordsExtensions
    {
        ...
        public static bool ContainsErrorCode<TKey, TErrorCode>(this ErrorRecords<TKey, TErrorCode> errorRecords, TErrorCode errorCode, params TErrorCode[] errorCodes)
        ...
        /// <returns>The <see cref="bool"/>.</returns>
        public static bool ContainsErrorCode<TKey, TErrorCode>(this ErrorRecords<TKey, TErrorCode> errorRecords, IEnumerable<TErrorCode> errorCodes)
            where TErrorCode : struct, Enum
        {
