namespace Framework.Business.Extension
{
    ...
    public static class LoggerExtensions
    {
        ...
        public static void LogTrace<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        public static void LogDebug<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        public static void LogInformation<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        public static void LogWarning<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        public static void LogError<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        public static void LogCritical<TKey, TErrorCode>(this ILogger logger, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
        ...
        /// <param name="actionName">The actionName<see cref="string"/>.</param>
        /// <param name="message">The message<see cref="string"/>.</param>
        private static void LogManagerResponseHelper<TKey, TErrorCode>(ILogger logger, LogLevel level, ManagerResponse<TKey, TErrorCode> managerResponse, string actionName = null, string message = null)
            where TErrorCode : struct, Enum
        {
            try
            {
                ...
                if (managerResponse.HasError)
                {
                    ...
                    foreach (var errorRecord in managerResponse.ErrorRecords)
                    {
                        ...
                        {
                            sb.AppendLine($"Ordinal Position: {errorRecord.OrdinalPosition} | Id: {errorRecord.Key} | Error Code: {errorMessage.ErrorCode} | Property Name: {errorMessage.PropertyName} | Attempted Value: {errorMessage.AttemptedValue} | Message: {errorMessage.Message}");
                        }
                    }
                }
                else
                {
                    ...
                    if (managerResponse.Key != null)
                    {
                        var formattedIds = string.Join(", ", managerResponse.Key);
