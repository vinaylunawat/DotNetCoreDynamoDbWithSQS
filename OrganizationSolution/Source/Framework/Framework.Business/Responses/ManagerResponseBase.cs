namespace Framework.Business
{
    ...
    public abstract class ManagerResponseBase<TKey, TErrorCode>
        where TErrorCode : struct, Enum
    {
        ...
        public ManagerResponseBase(TErrorCode errorCode, string message)
        {
            ...
            ErrorRecords = new ErrorRecords<TKey, TErrorCode>
            {
                new ErrorRecord<TKey,TErrorCode>(errorCode, message)
            };
        }
        ...
        public ManagerResponseBase(TErrorCode errorCode, Exception exception)
        {
            ...
            ErrorRecords = new ErrorRecords<TKey,TErrorCode>
            {
                new ErrorRecord<TKey,TErrorCode>(errorCode, exception)
            };
        }
        ...
        public ManagerResponseBase(ErrorRecords<TKey, TErrorCode> errorRecords)
        {
        ...
        public ManagerResponseBase(Exception exception)
        {
            ...
            ErrorRecords = new ErrorRecords<TKey, TErrorCode>
            {
                new ErrorRecord<TKey,TErrorCode>(exception)
            };
        }
        ...
        /// </summary>
        public ErrorRecords<TKey, TErrorCode> ErrorRecords { get; set; }
    }
}
