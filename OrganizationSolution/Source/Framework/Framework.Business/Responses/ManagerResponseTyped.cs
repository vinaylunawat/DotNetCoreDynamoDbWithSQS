namespace Framework.Business
{
    ...
    public class ManagerResponseTyped<TKey, TErrorCode, TResult> : ManagerResponseBase<TKey, TErrorCode>
        where TErrorCode : struct, Enum
    {
        ...
        public ManagerResponseTyped(ErrorRecords<TKey, TErrorCode> errorRecords)
            : base(errorRecords)
        {
            Results = Array.Empty<TResult>();
        }
